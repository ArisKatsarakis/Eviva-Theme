...
?>
<div class="  w-full">
  <img src="<?php slidingImages(); ?>" class="z-0" />
  <div class="absolute right-2  inset-y-2/4  text-white transition ease-in-out">
  ...
  <div class="absolute left-2  inset-y-2/4  text-white transition ease-in-out z-0">
...
<div class="flex w-full items-center justify-center">
  <div class="flex-auto w-50  shadow-md mt-2 text-center rounded-3xl bg-creme border-2">
